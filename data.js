...
const TICKETS = [
  ...
  },
  {
    ...
    desc: "Die aus dem Unity Asset Store importierten Pickaxe-Modelle sind noch nicht korrekt im Spiel eingebaut. Positionierung, Skalierung und Textur-Mapping muessen angepasst werden.",
    status: "progress",
    priority: "critical",
    assignee: "hannes",
    tags: ["pickaxe", "bug"],
  ...
  },
  {
    ...
    desc: "Beim Abbauen sollen Schadenszahlen ueber dem Erz aufpoppen. Wichtiger Teil des Dopamin-Feedbacks. Zahlen sollen sich mit Upgrades erhoehen.",
    status: "backlog",
    priority: "high",
    assignee: null,
  ...
  },
  {
    ...
    desc: "Zentrale Config fuer alle Balance-Werte: Abbauzeiten, Drop-Mengen, XP-Kurven, Preise. Muss jederzeit einfach anpassbar sein ohne Code-Aenderungen.",
    status: "backlog",
    priority: "high",
    assignee: null,
    tags: ["system", "feature"],
  ...
  },
  {
    ...
    desc: "Komplettes Shop-Interface im Hub. Materialien fuer Waehrung verkaufen, Pickaxe-Damage/Drop-Rate/Player-Buffs kaufen.",
    status: "backlog",
    priority: "medium",
    assignee: null,
  ...
  },
  {
    ...
    desc: "Mehrere Leaderboards im Hub: Total Mined, Level, Waehrung, etc. Soll Spieler zum Grinden animieren.",
    status: "backlog",
    priority: "medium",
    assignee: null,
    tags: ["ui", "feature"],
